    ...
    css: [
      {
        ...
        /* H1
        fontsizes:
        - weitere Tweaks for mobile: See ProseH1
        - Overline: 15.75px
        - Headline: 35px
        - Shortcode: 63px
        - Tag (Monospace): 10.5px
         */
        ':is(h1, h1 > a) > strong': {
          marginTop: '6px',
          marginBottom: '5px',
        ...
        'h1:has(strong + mark) > strong': {
          paddingTop: '0px',
          paddingBottom: '1px', // fixes top-margin of Subline
        },
        // special style: colored Underline
        ':is(h1, h1 > a):has(strong + span):not(mark) > span': {
          marginLeft: '-16px',
          marginRight: '-16px',
          paddingLeft: '16px',
          paddingRight: '16px',
        ...
        // fontsize Shortcode: 49px
        ':is(h2, h2 > a) > mark': {
          // fontsize: ~10.3px
          marginRight: em(2, 14),
          paddingLeft: em(3, 14),
          paddingRight: em(3, 14),
        },
        'h2:has(strong + mark) > strong': {
          paddingTop: '0px',
          paddingBottom: '2px', // fixes top-margin of Subline
        },
        /* H3
        fontsizes:
        - Overline: 13.125px
        ...
        // fix Shortcode + Overline + Headline (Headline sitting too low)
        ':is(h3, h3 > a)::first-line:not(strong, em)': {
          marginBottom: '-3px',
        },
        ...
        ':is(h3, h3 > a) > mark': {
          marginRight: em(2, 14),
          paddingLeft: em(2, 14),
          paddingRight: em(2, 14),
        },
        'h3:has(strong + mark) > strong': {
          paddingTop: '0px',
          paddingBottom: '2px', // fixes top-margin of Subline
        },

        // special style: colored Underline
        ':is(h3, h3 > a):has(strong + span):not(mark) > span': {
          lineHeight: round(16 / 13.125),
        },
    ...
    css: [
      {
        ...
        ':is(h3, h3 > a) > mark': {
          marginRight: em(3, 16),
          paddingLeft: em(2, 16),
          paddingRight: em(3, 16),
        },
        'h3:has(strong + mark) > strong': {
          paddingTop: '0px',
          paddingBottom: '0px', // fixes top-margin of Subline
        },
        // special style: colored Underline
        ':is(h3, h3 > a):has(strong + span):not(:has(mark)) > span': {
          paddingLeft: '2px',
        },
        'h3 code': {
          fontSize: em(20, 24),
        ...
        - Tag (Monospace): 11px
         */
        ':is(.prose-obj, .prose-obj > a, .prose-obj > li) > strong': {
          marginTop: '0px',
          marginBottom: '2px',
        },

        ':is(.prose-obj, .prose-obj > a, .prose-obj > li) > mark': {
          marginRight: em(3, 14),
          paddingLeft: em(2, 14),
          paddingRight: em(3, 14),
        },
        '.prose-obj:has(strong + mark) > strong': {
          paddingTop: '0px',
          paddingBottom: '0px', // fixes top-margin of Subline
        },
        // special style: colored Underline
        ':is(.prose-obj, .prose-obj > a, .prose-obj > li):has(strong + span):not(:has(mark)) > span': {
          paddingLeft: '2px',
        },
    ...
    css: [
      {
        ...
        'h2:has(strong + mark) > strong': {
          paddingTop: '0px',
          paddingBottom: '3px', // fixes top-margin of Subline
        },
        'h3': {
          fontSize: em(36, 24),
          marginTop: em(56, 36),
    ...
    css: [
      {
        ...
        'h1': {
          ...
          fontWeight: '700',
          lineHeight: round(16 / 18),
        },
        ':is(h1, h1 > a) > strong': {
          fontSize: em(40, 16),
          display: 'block',
          fontWeight: '900',
          lineHeight: round(36 / 40),
        },
        // special style: colored Underline
        ':is(h1, h1 > a):has(strong + span):not(mark) > span': {
        ...
        'h2': {
          ...
          marginBottom: em(8, 24),
          fontWeight: '700',
          lineHeight: round(22.5 / 18),
        },
        ':is(h2, h2 > a) > strong': {
          fontSize: em(24, 16),
          display: 'block',
          fontWeight: '900',
          lineHeight: round(22.5 / 24),
        },
        ':is(h2, h2 > a) > em': {
          fontSize: em(56, 16),
          fontStyle: 'normal',
          lineHeight: round(46 / 56),
          marginRight: em(3, 16),
          float: 'left',
          fontWeight: '700',
        },
        ...
        ':is(h3, h3 > a)': {
          ...
          color: 'var(--tw-prose-headings)',
          marginTop: '0',
          marginBottom: em(4, 24),
          fontWeight: '900',
          lineHeight: round(22.5 / 18),
        },
        ':is(h3, h3 > a):has(strong, em)': {
          fontSize: em(16, 16),
          fontWeight: '700',
        },
        ':is(h3, h3 > a) > strong': {
        ...
        ':is(h3, h3 > a) > mark': {
          ...
          fontWeight: '600',
          fontSize: em(12, 16),
          lineHeight: round(15 / 16),
        },
        ':is(h3, h3 > a):has(em, strong)': {
          fontWeight: '300',
        },
        ':is(h3, h3 > a):has(em)': {
          letterSpacing: '-0.025em',
        ...
        ':is(.prose-obj, .prose-obj > li)': {
          fontSize: em(14, 16),
          marginLeft: '0',
        },

        ':is(.prose-obj, .prose-obj > a, .prose-obj > li)': {
          fontSize: em(14, 16),
          color: 'var(--tw-prose-headings)',
          marginTop: '0',
          marginBottom: em(4, 24),
        ...
        ':is(.prose-obj, .prose-obj > a, .prose-obj > li):has(strong, em)': {
          fontWeight: '500',
        },
        ':is(.prose-obj, .prose-obj > a, .prose-obj > li) > strong': {
          fontSize: em(16, 14),
        ...
        ':is(.prose-obj, .prose-obj > a, .prose-obj > li) > em': {
          fontSize: em(40, 14),
          fontStyle: 'normal',
          lineHeight: round(46 / 56),
          marginRight: em(2, 14),
        ...
        ':is(.prose-obj, .prose-obj > li) > mark': {
          // fontsize: 12px
          float: 'blockStart',
          textTransform: 'uppercase',
          backgroundColor: 'gray',
        ...
        ':is(.prose-obj, .prose-obj > a, .prose-obj > li):has(em, strong)': {
          fontWeight: '300',
        },
        ':is(.prose-obj, .prose-obj > a, .prose-obj > li):has(em)': {
          letterSpacing: '-0.025em',
        },
        // special style: colored Underline
        ':is(.prose-obj, .prose-obj > a, .prose-obj > li):has(strong + span):not(mark) > span': {
          backgroundColor: 'gold',
          fontSize: em(14, 14),
          lineHeight: '16px',
          display: 'block',
